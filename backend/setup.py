...
def check_database():
    ...
    db_file = Path(__file__).parent.parent / 'database' / 'smart_bank.db'
    ...
    if db_file.exists():
        ...
        print_info("Run: python database/init_database.py")
        return False
...
def initialize_database():
    ...
    db_init_script = Path(__file__).parent.parent / 'database' / 'init_database.py'
